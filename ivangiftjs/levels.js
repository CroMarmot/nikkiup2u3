 ...
 */
 var levelBonus = {
  ...
  '15-1': [addBonusInfo('C', 0.5, "运动系")],
  '15-2': [addBonusInfo('B', 1, "洛丽塔")],
  '15-4': [addBonusInfo('C', 0.5, "中式古典"), addBonusInfo('C', 0.5, "侠客联盟")],
  '15-5': [addBonusInfo('C', 1, "冬装")],
  '15-6': [addBonusInfo('B', 1, "中性风")],
  '15-7': [addBonusInfo('A', 1, "英伦")],
  '15-8': [addBonusInfo('C', 1, "军装")],
  '15-9': [addBonusInfo('A', 1, "军装"), addBonusInfo('C', 0.5, "中性风")],
  ...
  '满天繁星: 第四天': [addBonusInfo('A', 1, "中式古典"), addBonusInfo('A', 1, "中式现代")],
  '满天繁星: 第五天': [addBonusInfo('A', 1, "侠客联盟")],
  '满天繁星: 第七天（预计）': [addBonusInfo('A', 1, "中式古典"), addBonusInfo('A', 1, "中式现代")],
  ...
  '医疗所之谜1': [addBonusInfo('A', 0.5, "冬装")],
  '医疗所之谜2': [addBonusInfo('S', 1, "哥特风")],
